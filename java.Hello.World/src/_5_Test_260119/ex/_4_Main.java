...
public class _4_Main {
    public static void main(String[] args) {
        ...
        _4_MemberBase[] members = new _4_MemberBase[5];
        ...
        while (true) {
            System.out.println("\n=============회원 관리 시스템 ver 1.0=======");
            System.out.println("1. 회원가입 2. 목록조회 4. 로그인 3. 종료");
            ...
            switch(choice) {
                case 1: // 회원 가입.
                    ...
                    _4_NormalMember newMember = new _4_NormalMember(name,email,age,password);                   // 배열에 저장.
